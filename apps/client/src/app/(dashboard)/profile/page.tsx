...
const Profile = () => {
  ...
  const handleCompleteProfile = async (e: React.FormEvent) => {
    ...
    if (completeProfileForm.password !== completeProfileForm.confirmPassword) {
      setUpdateError('Passwords do not match');
      return;
    }

    if (completeProfileForm.password.length < 6) {
      setUpdateError('Password must be at least 6 characters');
      return;
    }
          ...
          <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-lg">
            {updateSuccess && (
              <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl flex items-center gap-3">
                ...
                <p className="text-green-700 text-sm">Profile completed successfully!</p>
              </div>
            )}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    required
                    value={completeProfileForm.firstName}
                    onChange={(e) => setCompleteProfileForm({ ...completeProfileForm, firstName: e.target.value })}
                ...
                <div>
                  ...
                  <input
                    type="text"
                    required
                    value={completeProfileForm.lastName}
                    onChange={(e) => setCompleteProfileForm({ ...completeProfileForm, lastName: e.target.value })}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 bg-white text-gray-900"
                    placeholder="Doe"
                  />
                </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    value={completeProfileForm.password}
                    onChange={(e) => setCompleteProfileForm({ ...completeProfileForm, password: e.target.value })}
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    value={completeProfileForm.confirmPassword}
                    onChange={(e) => setCompleteProfileForm({ ...completeProfileForm, confirmPassword: e.target.value })}
                    className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-900 bg-white text-gray-900"
